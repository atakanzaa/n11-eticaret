package com.smartcommerce.returns.job;

import com.smartcommerce.returns.repository.ProcessedEventRepository;
...
public class ProcessedEventCleanupJob {
    ...
    public void cleanup() {
        ...
        if (deleted > 0) {
            log.info("[return] Pruned {} processed_events rows older than {}", deleted, cutoff);
        }
    }
}
